/*
 * Remaked J P List  - jQuery plugin for sorting, filtering and paging
 */
                ...
                this.filterData = function(data){
                    ...
                    for (var i=0; i<data.length; i++){
                        ...
                        f_hndl.input_fields.each(function(){
                            ...
                            var data_filter_arr=val.split(",");
                            $.each(data_filter_arr,function(f_ind,f_val){
                                x_counter=0;
                                if((f_hndl.format(data_item[0]).indexOf(f_val) != -1) ||
                                    ($.trim(f_val) == "")){
                                    x_counter++;
                                    return false;
                                }
...
//			console.info(this.sort_dd)

//                        console.info(this.paging_dd)
...
$(options.sort_btns).click(function(){
                ...
                this.initDD = function(){
                    ...
                    var order_val = hndl.sortObj.order;
                    var sort_is_num_val = Boolean(hndl.sortObj.sort_is_num);
//				console.info(items_on_page_val)
                ...
                this.paging_dd.find("li").click(function(){
                    var val = $(this).find("a").attr("class").replace("pg", "");
//                    console.info(val);
            ...
            function PagingClass(){
                ...
                this.pagingbox.html("<ol class='list_pages bottom_nav' ><span id='pagingprev'></span><span id='pagingmid' ></span><span  class='list_pages bottom_nav' id='pagingnext'></span></ol>");
                ...
                //			this.pagingmid = this.pagingbox.find("#pagingmid");
                //			this.pagingnext = this.pagingbox.find("#pagingnext");
//                this.pagingprev.html("<li class='first'>&laquo;</li><li class='nav_prev'><a href='#' onClick='return false'>Предыдущая</a></li>");
//                this.pagingnext.html("<li class='nav_next'><a href='#' onClick='return false'>Следующая</a></li><li class='last'>&raquo;</li>");
                this.pagingprev.html("<li class='nav_prev'><a href='#' onClick='return false'>Предыдущая</a></li>");
                this.pagingnext.html("<li class='nav_next'><a href='#' onClick='return false'>Следующая</a></li>");
                this.first = this.pagingprev.find(".first_disable");
                this.prev = this.pagingprev.find(".nav_prev");
                this.next = this.pagingnext.find(".nav_next");
                this.last = this.pagingnext.find(".last_disable");
                ...
                this.setPaging = function(data){
			            console.info(p_hndl.items_on_page)
                ...
                this.updateBullets = function(){
                    ...
                    if(p_hndl.cpage >= 0 && p_hndl.cpage < p_hndl.get_pages_num(p_hndl.items_on_page)){
                        ...
                        html +=	"<ol class='list_pages bottom_nav' style='display:inline' id='pagesbox'>";
                        for(var i=start; i<end; i++){
                            ...
                            html += "><a href='#' onClick='return false'>" + (eval(i) + 1) + "</a></li> ";
                        }
                        html +=	"</ol>";
					
                        p_hndl.pagingmid.html(html);
                        p_hndl.pagingmid.find("li").unbind().click(function(){
