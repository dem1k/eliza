...
<?=form_open_multipart('admin/map/edittext/');?>
<?=form_error("text","<span class='error'>","</span><br/>")?>
<h2>Текст для карты</h2><br/>


            <textarea cols="70" rows="10"name="text"><?=set_value("text",$text->text)?></textarea>
