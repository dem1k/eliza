...
<table cellspacing="0">
    ...
    <tr>
        ...
        <td>
            <select name="category">
                ...
                <option
                    value="<?php echo $category['id']?>"<?php echo  $category['name'] == $product['category'] ? set_select('category', $category['id'], true) : set_select('category', $category['id'], false)?> > <?php echo $category['name']?></option>
                <?php endforeach;?>
            </select>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <div id="container">
                <?php $images = isset($images)?$images:array();?>
